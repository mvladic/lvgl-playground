...
var ASM_CONSTS = {
  1064128: ($0) => { startToDebuggerMessage($0); },  
 1064160: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1064235: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1064310: ($0) => { finishToDebuggerMessage($0); },  
 1064343: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1064373: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1064403: ($0) => { lvglScreenTick($0); },  
 1064427: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1064467: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1064521: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
 ...
 1064848: ($0, $1) => { js_dispatch_event($0, $1); },  
 1064879: ($0, $1, $2, $3, $4, $5) => { return eez_mqtt_init($0, UTF8ToString($1), UTF8ToString($2), $3, UTF8ToString($4), UTF8ToString($5)); },  
 1064985: ($0, $1) => { return eez_mqtt_deinit($0, $1); },  
 1065021: ($0, $1) => { return eez_mqtt_connect($0, $1); },  
 1065058: ($0, $1) => { return eez_mqtt_disconnect($0, $1); },  
 1065098: ($0, $1, $2) => { return eez_mqtt_subscribe($0, $1, UTF8ToString($2)); },  
 1065155: ($0, $1, $2) => { return eez_mqtt_unsubscribe($0, $1, UTF8ToString($2)); },  
 1065214: ($0, $1, $2, $3) => { return eez_mqtt_publish($0, $1, UTF8ToString($2), UTF8ToString($3)); }
};
