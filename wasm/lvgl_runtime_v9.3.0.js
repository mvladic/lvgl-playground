...
function findWasmBinary() {
  return locateFile('lvgl_runtime_v9.3.0.wasm');
}
...
var ASM_CONSTS = {
  1059424: ($0) => { startToDebuggerMessage($0); },  
 1059456: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1059531: ($0, $1, $2) => { writeDebuggerBuffer($0, new Uint8Array(Module.HEAPU8.buffer, $1, $2)); },  
 1059606: ($0) => { finishToDebuggerMessage($0); },  
 1059639: ($0, $1) => { lvglCreateScreen($0, $1); },  
 1059669: ($0, $1) => { lvglDeleteScreen($0, $1); },  
 1059699: ($0) => { lvglScreenTick($0); },  
 1059723: ($0, $1, $2, $3) => { lvglOnEventHandler($0, $1, $2, $3); },  
 1059763: ($0, $1) => { return getLvglScreenByName($0, UTF8ToString($1)); },  
 1059817: ($0, $1) => { return getLvglObjectByName($0, UTF8ToString($1)); },  
...
var _lv_text_get_width_with_flags = Module['_lv_text_get_width_with_flags'] = makeInvalidEarlyAccess('_lv_text_get_width_with_flags');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['lv_text_get_width_with_flags'] != 'undefined', 'missing Wasm export: lv_text_get_width_with_flags');
