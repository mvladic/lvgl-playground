...
var _lv_obj_update_flag = Module['_lv_obj_update_flag'] = makeInvalidEarlyAccess('_lv_obj_update_flag');
...
var _lv_gradient_color_calculate = Module['_lv_gradient_color_calculate'] = makeInvalidEarlyAccess('_lv_gradient_color_calculate');
var _lv_gradient_cleanup = Module['_lv_gradient_cleanup'] = makeInvalidEarlyAccess('_lv_gradient_cleanup');
var _lv_gradient_init_stops = Module['_lv_gradient_init_stops'] = makeInvalidEarlyAccess('_lv_gradient_init_stops');
...
var _lv_mutex_init = Module['_lv_mutex_init'] = makeInvalidEarlyAccess('_lv_mutex_init');
var _lv_mutex_delete = Module['_lv_mutex_delete'] = makeInvalidEarlyAccess('_lv_mutex_delete');
var _lv_mutex_lock = Module['_lv_mutex_lock'] = makeInvalidEarlyAccess('_lv_mutex_lock');
var _lv_mutex_unlock = Module['_lv_mutex_unlock'] = makeInvalidEarlyAccess('_lv_mutex_unlock');
...
var _lv_font_default = Module['_lv_font_default'] = makeInvalidEarlyAccess('_lv_font_default');
...
var _lv_anim_set_time = Module['_lv_anim_set_time'] = makeInvalidEarlyAccess('_lv_anim_set_time');
...
var _lv_anim_set_playback_duration = Module['_lv_anim_set_playback_duration'] = makeInvalidEarlyAccess('_lv_anim_set_playback_duration');
var _lv_anim_set_playback_time = Module['_lv_anim_set_playback_time'] = makeInvalidEarlyAccess('_lv_anim_set_playback_time');
var _lv_anim_set_playback_delay = Module['_lv_anim_set_playback_delay'] = makeInvalidEarlyAccess('_lv_anim_set_playback_delay');
...
var _lv_array_is_empty = Module['_lv_array_is_empty'] = makeInvalidEarlyAccess('_lv_array_is_empty');
...
var _lv_array_size = Module['_lv_array_size'] = makeInvalidEarlyAccess('_lv_array_size');
var _lv_array_capacity = Module['_lv_array_capacity'] = makeInvalidEarlyAccess('_lv_array_capacity');
var _lv_array_is_full = Module['_lv_array_is_full'] = makeInvalidEarlyAccess('_lv_array_is_full');
var _lv_array_clear = Module['_lv_array_clear'] = makeInvalidEarlyAccess('_lv_array_clear');
var _lv_array_front = Module['_lv_array_front'] = makeInvalidEarlyAccess('_lv_array_front');
var _lv_array_back = Module['_lv_array_back'] = makeInvalidEarlyAccess('_lv_array_back');
...
var _lv_thread_init = Module['_lv_thread_init'] = makeInvalidEarlyAccess('_lv_thread_init');
var _lv_thread_delete = Module['_lv_thread_delete'] = makeInvalidEarlyAccess('_lv_thread_delete');
var _lv_mutex_lock_isr = Module['_lv_mutex_lock_isr'] = makeInvalidEarlyAccess('_lv_mutex_lock_isr');
var _lv_thread_sync_init = Module['_lv_thread_sync_init'] = makeInvalidEarlyAccess('_lv_thread_sync_init');
var _lv_thread_sync_wait = Module['_lv_thread_sync_wait'] = makeInvalidEarlyAccess('_lv_thread_sync_wait');
var _lv_thread_sync_signal = Module['_lv_thread_sync_signal'] = makeInvalidEarlyAccess('_lv_thread_sync_signal');
var _lv_thread_sync_signal_isr = Module['_lv_thread_sync_signal_isr'] = makeInvalidEarlyAccess('_lv_thread_sync_signal_isr');
var _lv_thread_sync_delete = Module['_lv_thread_sync_delete'] = makeInvalidEarlyAccess('_lv_thread_sync_delete');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['lv_obj_update_flag'] != 'undefined', 'missing Wasm export: lv_obj_update_flag');
  ...
  assert(typeof wasmExports['lv_gradient_color_calculate'] != 'undefined', 'missing Wasm export: lv_gradient_color_calculate');
  assert(typeof wasmExports['lv_gradient_cleanup'] != 'undefined', 'missing Wasm export: lv_gradient_cleanup');
  assert(typeof wasmExports['lv_gradient_init_stops'] != 'undefined', 'missing Wasm export: lv_gradient_init_stops');
  ...
  assert(typeof wasmExports['lv_mutex_init'] != 'undefined', 'missing Wasm export: lv_mutex_init');
  assert(typeof wasmExports['lv_mutex_delete'] != 'undefined', 'missing Wasm export: lv_mutex_delete');
  assert(typeof wasmExports['lv_mutex_lock'] != 'undefined', 'missing Wasm export: lv_mutex_lock');
  assert(typeof wasmExports['lv_mutex_unlock'] != 'undefined', 'missing Wasm export: lv_mutex_unlock');
  ...
  assert(typeof wasmExports['lv_font_default'] != 'undefined', 'missing Wasm export: lv_font_default');
  ...
  assert(typeof wasmExports['lv_anim_set_time'] != 'undefined', 'missing Wasm export: lv_anim_set_time');
  ...
  assert(typeof wasmExports['lv_anim_set_playback_duration'] != 'undefined', 'missing Wasm export: lv_anim_set_playback_duration');
  assert(typeof wasmExports['lv_anim_set_playback_time'] != 'undefined', 'missing Wasm export: lv_anim_set_playback_time');
  assert(typeof wasmExports['lv_anim_set_playback_delay'] != 'undefined', 'missing Wasm export: lv_anim_set_playback_delay');
  ...
  assert(typeof wasmExports['lv_array_is_empty'] != 'undefined', 'missing Wasm export: lv_array_is_empty');
  ...
  assert(typeof wasmExports['lv_array_size'] != 'undefined', 'missing Wasm export: lv_array_size');
  assert(typeof wasmExports['lv_array_capacity'] != 'undefined', 'missing Wasm export: lv_array_capacity');
  assert(typeof wasmExports['lv_array_is_full'] != 'undefined', 'missing Wasm export: lv_array_is_full');
  assert(typeof wasmExports['lv_array_clear'] != 'undefined', 'missing Wasm export: lv_array_clear');
  assert(typeof wasmExports['lv_array_front'] != 'undefined', 'missing Wasm export: lv_array_front');
  assert(typeof wasmExports['lv_array_back'] != 'undefined', 'missing Wasm export: lv_array_back');
  ...
  assert(typeof wasmExports['lv_thread_init'] != 'undefined', 'missing Wasm export: lv_thread_init');
  assert(typeof wasmExports['lv_thread_delete'] != 'undefined', 'missing Wasm export: lv_thread_delete');
  assert(typeof wasmExports['lv_mutex_lock_isr'] != 'undefined', 'missing Wasm export: lv_mutex_lock_isr');
  assert(typeof wasmExports['lv_thread_sync_init'] != 'undefined', 'missing Wasm export: lv_thread_sync_init');
  assert(typeof wasmExports['lv_thread_sync_wait'] != 'undefined', 'missing Wasm export: lv_thread_sync_wait');
  assert(typeof wasmExports['lv_thread_sync_signal'] != 'undefined', 'missing Wasm export: lv_thread_sync_signal');
  assert(typeof wasmExports['lv_thread_sync_signal_isr'] != 'undefined', 'missing Wasm export: lv_thread_sync_signal_isr');
  assert(typeof wasmExports['lv_thread_sync_delete'] != 'undefined', 'missing Wasm export: lv_thread_sync_delete');
  ...
  _lv_obj_update_flag = Module['_lv_obj_update_flag'] = createExportWrapper('lv_obj_update_flag', 3);
  ...
  _lv_draw_add_task = Module['_lv_draw_add_task'] = createExportWrapper('lv_draw_add_task', 2);
  ...
  _lv_text_get_next_line = Module['_lv_text_get_next_line'] = createExportWrapper('lv_text_get_next_line', 6);
  ...
  _lv_gradient_color_calculate = Module['_lv_gradient_color_calculate'] = createExportWrapper('lv_gradient_color_calculate', 5);
  _lv_gradient_cleanup = Module['_lv_gradient_cleanup'] = createExportWrapper('lv_gradient_cleanup', 1);
  _lv_gradient_init_stops = Module['_lv_gradient_init_stops'] = createExportWrapper('lv_gradient_init_stops', 5);
  ...
  _lv_mutex_init = Module['_lv_mutex_init'] = createExportWrapper('lv_mutex_init', 1);
  _lv_mutex_delete = Module['_lv_mutex_delete'] = createExportWrapper('lv_mutex_delete', 1);
  _lv_mutex_lock = Module['_lv_mutex_lock'] = createExportWrapper('lv_mutex_lock', 1);
  _lv_mutex_unlock = Module['_lv_mutex_unlock'] = createExportWrapper('lv_mutex_unlock', 1);
  ...
  _lv_draw_sw_mask_rect = Module['_lv_draw_sw_mask_rect'] = createExportWrapper('lv_draw_sw_mask_rect', 3);
  ...
  _lv_font_default = Module['_lv_font_default'] = createExportWrapper('lv_font_default', 0);
  ...
  _lv_anim_set_time = Module['_lv_anim_set_time'] = createExportWrapper('lv_anim_set_time', 2);
  ...
  _lv_anim_set_playback_duration = Module['_lv_anim_set_playback_duration'] = createExportWrapper('lv_anim_set_playback_duration', 2);
  _lv_anim_set_playback_time = Module['_lv_anim_set_playback_time'] = createExportWrapper('lv_anim_set_playback_time', 2);
  _lv_anim_set_playback_delay = Module['_lv_anim_set_playback_delay'] = createExportWrapper('lv_anim_set_playback_delay', 2);
  ...
  _lv_array_is_empty = Module['_lv_array_is_empty'] = createExportWrapper('lv_array_is_empty', 1);
  ...
  _lv_array_size = Module['_lv_array_size'] = createExportWrapper('lv_array_size', 1);
  _lv_array_capacity = Module['_lv_array_capacity'] = createExportWrapper('lv_array_capacity', 1);
  _lv_array_is_full = Module['_lv_array_is_full'] = createExportWrapper('lv_array_is_full', 1);
  _lv_array_clear = Module['_lv_array_clear'] = createExportWrapper('lv_array_clear', 1);
  _lv_array_front = Module['_lv_array_front'] = createExportWrapper('lv_array_front', 1);
  _lv_array_back = Module['_lv_array_back'] = createExportWrapper('lv_array_back', 1);
  ...
  _lv_thread_init = Module['_lv_thread_init'] = createExportWrapper('lv_thread_init', 5);
  _lv_thread_delete = Module['_lv_thread_delete'] = createExportWrapper('lv_thread_delete', 1);
  _lv_mutex_lock_isr = Module['_lv_mutex_lock_isr'] = createExportWrapper('lv_mutex_lock_isr', 1);
  _lv_thread_sync_init = Module['_lv_thread_sync_init'] = createExportWrapper('lv_thread_sync_init', 1);
  _lv_thread_sync_wait = Module['_lv_thread_sync_wait'] = createExportWrapper('lv_thread_sync_wait', 1);
  _lv_thread_sync_signal = Module['_lv_thread_sync_signal'] = createExportWrapper('lv_thread_sync_signal', 1);
  _lv_thread_sync_signal_isr = Module['_lv_thread_sync_signal_isr'] = createExportWrapper('lv_thread_sync_signal_isr', 1);
  _lv_thread_sync_delete = Module['_lv_thread_sync_delete'] = createExportWrapper('lv_thread_sync_delete', 1);
